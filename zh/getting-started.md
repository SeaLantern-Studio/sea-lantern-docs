...
你可以使用 Minecraft 服务端 JAR 创建新服务器，也可以直接导入已有服务器目录或启动脚本。如果你还没有核心文件，请参考 [核心获取](/zh/server-jar) 页面下载。
...
点击启动按钮，等待控制台出现类似 `Done (1.234s)! For help, type "help"` 的日志，即表示服务器启动成功。此时你可以在 Minecraft 中通过 `localhost` 连接到你的服务器。
